  ...
  const events = [
    {
      ...
      name: "Q & A",
      description:
        "The Campus Ambassador Program is launching a brand new event to help applicants answer all their inquiries. Prospective applicants can attend our virtual Information and Q&A sessions with our panelist from various backgrounds. We will have a plethora of students with unique backgrounds to share their journey to Sauder and answer any of your questions! We welcome all students interested in Sauder to attend.",
      imageUrl: { QandA },
    },
    {
      id: 2,
    ...
    },
    {
      ...
      description:
        "Every year, CAP hosts their very own case competition that gives participants an opportunity to develop and apply their critical thinking and problem-solving skills in a business context.",
